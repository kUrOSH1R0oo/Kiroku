...
class MyServlet < WEBrick::HTTPServlet::AbstractServlet
  ...
  def initialize(server, keystrokes_file_path, clipboard_file_path, screenshots_dir)
    super(server)
...
server.mount '/', MyServlet, keystrokes_file_path, clipboard_file_path, screenshots_dir # Mount the custom servlet
